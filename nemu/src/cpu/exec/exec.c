...
opcode_entry opcode_table [512] = {
  ...
  /* 0xb4 */	IDEXW(mov_I2r, mov, 1), IDEXW(mov_I2r, mov, 1), IDEXW(E2G, movzx, 1), IDEXW(E2G, movzx, 2),
  /* 0xb8 */	IDEX(mov_I2r, mov), IDEX(mov_I2r, mov), IDEXW(E2G, movsx, 1), IDEXW(E2G, movsx, 2),
