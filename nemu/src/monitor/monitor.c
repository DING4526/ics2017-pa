...
const uint8_t img[] = {
  // mov eax, 0xf0f0f0f0
  0xb8, 0xf0, 0xf0, 0xf0, 0xf0,

  // mov ebx, 0x0f0f0f0f
  0xbb, 0x0f, 0x0f, 0x0f, 0x0f,

  // and eax, ebx -> eax = 0
  0x21, 0xd8,

  // or eax, ebx -> eax = 0x0f0f0f0f
  0x09, 0xd8,

  // xor eax, 0xffffffff -> eax = 0xf0f0f0f0
  0x83, 0xf0, 0xff,
  ...
  // mov eax, 0xfffffff0
  0xb8, 0xf0, 0xff, 0xff, 0xff,

  // sar eax, 1 -> eax = 0xfffffff8
  0xc1, 0xf8, 0x01,
